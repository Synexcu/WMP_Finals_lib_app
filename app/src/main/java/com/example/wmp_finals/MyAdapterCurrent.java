...
public class MyAdapterCurrent extends RecyclerView.Adapter<MyAdapterCurrent.MyViewHolder> {
    ...
    public MyAdapterCurrent(Context ct, String s1[], String s2[], String s3[], String s4[], String s5[], String s6[], int img[], String indexx[]) {
        context = ct;
        data1 = s1;
        data2 = s2;
        data3 = s3;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.my_row_current, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            ...
            holder.mainLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(context, recyclerSeeBookTemplate_current.class);
            ...
            holder.delBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    editor.apply();
                    Intent fav = new Intent(context, recycler_current.class);
