...
public class recycler_want extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycler_want);
        ...
        news1 = transferString(s1, loadData(s1.length), "Want");
        news2 = transferString(s2, loadData(s1.length), "Want");
        news3 = transferString(s3, loadData(s1.length), "Want");
        news4 = transferString(s4, loadData(s1.length), "Want");
        news5 = transferString(s5, loadData(s1.length), "Want");
        news6 = transferString(s6, loadData(s1.length), "Want");
        newImage = transferInt(images, loadData(s1.length), "Want");


        MyAdapterWant myAdapter = new MyAdapterWant(this, news1, news2, news3, news4, news5, news6, newImage, index);
