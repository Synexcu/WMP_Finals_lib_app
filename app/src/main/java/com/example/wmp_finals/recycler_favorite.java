...
public class recycler_favorite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycler_favorite);
        ...
        news1 = transferString(s1, loadData(s1.length), "true");
        news2 = transferString(s2, loadData(s1.length), "true");
        news3 = transferString(s3, loadData(s1.length), "true");
        news4 = transferString(s4, loadData(s1.length), "true");
        news5 = transferString(s5, loadData(s1.length), "true");
        news6 = transferString(s6, loadData(s1.length), "true");
        newImage = transferInt(images, loadData(s1.length), "true");


        MyAdapterFavorite myAdapter = new MyAdapterFavorite(this, news1, news2, news3, news4, news5, news6, newImage, index);
