...
public class recycler_already extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycler_already);
        ...
        news1 = transferString(s1, loadData(s1.length), "Already");
        news2 = transferString(s2, loadData(s1.length), "Already");
        news3 = transferString(s3, loadData(s1.length), "Already");
        news4 = transferString(s4, loadData(s1.length), "Already");
        news5 = transferString(s5, loadData(s1.length), "Already");
        news6 = transferString(s6, loadData(s1.length), "Already");
        newImage = transferInt(images, loadData(s1.length), "Already");


        MyAdapterAlready myAdapter = new MyAdapterAlready(this, news1, news2, news3, news4, news5, news6, newImage, index);
