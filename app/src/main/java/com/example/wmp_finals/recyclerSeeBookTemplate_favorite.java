...
public class recyclerSeeBookTemplate_favorite extends AppCompatActivity {
...
//    int images[] = {R.drawable.katainaka_no_ossan, R.drawable.spy_x_family};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bookdetails_favorite);
...
//        recyclerViewSeeBookTemplate.setLayoutManager(new LinearLayoutManager((this)));
    ...
    private void getData() {
        if(getIntent().hasExtra("myImage") && getIntent().hasExtra("data1") && getIntent().hasExtra("data2") && getIntent().hasExtra("data3") && getIntent().hasExtra("descdata") &&
            getIntent().hasExtra("index") && getIntent().hasExtra("pagedata")) {
            ...
            index = Integer.toString(getIntent().getIntExtra("index", 1));
            Log.v("tag", index);
